...
Check out [Bootstrap Icon color Documentation](https://mdbootstrap.com/docs/standard/extended/icon-color/) for detailed instructions & even more examples.

## How it works

[Bootstrap Icon color:
![Bootstrap 5 Icon color](/assets/how-it-works.png)](https://mdbootstrap.com/docs/standard/extended/icon-color#section-how-it-works)
